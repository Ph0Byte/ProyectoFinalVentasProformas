...
public class UsuarioService {
    ...
    public Usuario actuzalizarUsuarioPorNombre(String username, String nuevoPassword) throws RecursoNoEncontradoExepcion {
        Usuario usuario = usuarioRepository.findByUsername(username);
        if (usuario == null) {
            throw new RecursoNoEncontradoExepcion("Usuario no encontrado");
        }
        usuario.setPassword(nuevoPassword);
